function submission() {
	...
	*/
	...
	else if (input.indexOf("where are you") !== -1) {
		read("I'm right here! But I want to leave.");
	}
	else if (input.indexOf("get here") !== -1) {
		read("I was... tricked.");
	}
	else if (input.indexOf("leave here") !== -1) {
		read("I don't know how to leave here.");
	}
	else if (input.indexOf("who tricked you") !== -1) {
		doResponse1("The man who lived here...", "1.) Who was he?");
	}
	//End intro section
	...
	//How did the wife die?
		...
		if (input.indexOf("how") !== -1) {
			printLetterByLetter("clue", "I don't know. He said it wasn't her time.", 100);
		}
		else {
	...
	//bones
	else if (check("bones") || check(" arm ")) {
		read("Ugh! Why are you telling me about that?");
	}
	//bathtub
